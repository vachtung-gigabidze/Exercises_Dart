  ...
  group('Pangram', () {
    group('Check if the given string is a pangram', () {
      ...
      test("pangram with underscores", () {
        final bool result =
            pangram.isPangram("the_quick_brown_fox_jumps_over_the_lazy_dog");
        expect(result, equals(true));
      }, skip: false);

      test("pangram with numbers", () {
        final bool result = pangram
      ...
      test("missing letters replaced by numbers", () {
        final bool result =
            pangram.isPangram("7h3 qu1ck brown fox jumps ov3r 7h3 lazy dog");
        expect(result, equals(false));
      }, skip: false);

      test("pangram with mixed case and punctuation", () {
        final bool result =
            pangram.isPangram("\"Five quacking Zephyrs jolt my wax bed.\"");
        expect(result, equals(true));
      }, skip: false);
      ...
      test(
          ...
          () {
        final bool result =
            pangram.isPangram("the quick brown fox jumps over with lazy FX");
        expect(result, equals(false));
      }, skip: false);
    });
  });
