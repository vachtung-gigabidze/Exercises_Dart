...
void numberLengthTest() {
  test('invalid when 9 digits', () {
    expect(
        ...
        throwsA(predicate<FormatException>((e) =>
            ...
            e.message == 'incorrect number of digits')));
  }, skip: false);
  ...
  test('invalid when 11 digits does not start with a 1', () {
    expect(
        ...
        throwsA(predicate<FormatException>((e) =>
            e is FormatException &&
            e.message == '11 digits must start with 1')));
  }, skip: false);
  ...
  test('invalid when more than 11 digits', () {
    expect(
        ...
        throwsA(predicate<FormatException>((e) =>
            e is FormatException && e.message == 'more than 11 digits')));
  }, skip: false);
}
...
void numbersOnlyTest() {
  test('invalid with letters', () {
    expect(
        ...
        throwsA(predicate<FormatException>((e) =>
            e is FormatException && e.message == 'letters not permitted')));
  }, skip: false);
  ...
  test('invalid with punctuations', () {
    expect(
        ...
        throwsA(predicate<FormatException>((e) =>
            e is FormatException &&
            e.message == 'punctuations not permitted')));
  }, skip: false);
}
...
void areaCodeTests() {
  test('invalid if area code starts with 0', () {
    expect(
        ...
        throwsA(predicate<FormatException>((e) =>
            e is FormatException &&
            e.message == 'area code cannot start with zero')));
  }, skip: false);
  ...
  test('invalid if area code starts with 1', () {
    expect(
        ...
        throwsA(predicate<FormatException>((e) =>
            e is FormatException &&
            e.message == 'area code cannot start with one')));
  }, skip: false);
}
...
void exchangeCodeTests() {
  test('invalid if exchange code starts with 0', () {
    expect(
        ...
        throwsA(predicate<FormatException>((e) =>
            e is FormatException &&
            e.message == 'exchange code cannot start with zero')));
  }, skip: false);
  ...
  test('invalid if exchange code starts with 1', () {
    expect(
        ...
        throwsA(predicate<FormatException>((e) =>
            e is FormatException &&
            e.message == 'exchange code cannot start with one')));
  }, skip: false);
